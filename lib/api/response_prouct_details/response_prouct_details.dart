...
class ResponseProuctDetails {
	...
	factory ResponseProuctDetails.fromJson(Map<String, Object?> json) {
		return ResponseProuctDetails(
			id: json['id'] as int?,
			...
			dimensions: json['dimensions'] == null
						? null
						: Dimensions.fromJson(json['dimensions']! as Map<String, Object?>),
			...
			images: (json['images'] as List<dynamic>?)
						?.map((e) => Image.fromJson(e as Map<String, Object?>))
						.toList(),
			attributes: (json['attributes'] as List<dynamic>?)
						?.map((e) => Attribute.fromJson(e as Map<String, Object?>))
						.toList(),
	...
	bool operator ==(Object other) {
		...
		if (other is! ResponseProuctDetails) return false;
